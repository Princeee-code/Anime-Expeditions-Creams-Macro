"""
API module: Exposed to the frontend as ``pywebview.api.*`` -- the JS <> Python
bridge.  Extracted from the original main.py monolith.
...
GUI_TITLE = "Herm's Engine | Anime Expeditions"
...
class Api:
    ...
    YOUTUBE_CHANNEL_URL = "https://www.youtube.com/@HermsEngine/videos"
